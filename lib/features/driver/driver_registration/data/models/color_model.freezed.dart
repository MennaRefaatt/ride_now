...
abstract class $ColorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String hexCode});
}
...
class _$ColorModelImpl implements _ColorModel {
  const _$ColorModelImpl({required this.name, required this.hexCode});
  ...
  @override
  String toString() {
    return 'ColorModel(name: $name, hexCode: $hexCode)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, hexCode);
...
abstract class _ColorModel implements ColorModel {
  const factory _ColorModel(
      ...
      required final String hexCode}) = _$ColorModelImpl;

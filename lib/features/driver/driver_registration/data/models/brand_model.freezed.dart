...
class _$BrandModelImpl implements _BrandModel {
  const _$BrandModelImpl({required this.name, required this.country});
  ...
  @override
  String toString() {
    return 'BrandModel(name: $name, country: $country)';
  }
...
abstract class _BrandModel implements BrandModel {
  const factory _BrandModel(
      ...
      required final String country}) = _$BrandModelImpl;

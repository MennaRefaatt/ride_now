...
class TextStyles {
  ...
  static TextStyle font13primaryMedium = TextStyle(
    fontSize: 13.sp,
  ...
  static TextStyle font15primaryMedium = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.medium,
    color: AppColors.primary,
  );
  ...
  static TextStyle get font18BlackRegular => TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.regular,
    color: AppColors.black,
  );
  ...
  static TextStyle get font12WhiteBold => TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.bold,
    color: Colors.white,
  );

  static TextStyle get font14WhiteRegular => TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.regular,
    color: Colors.white,
  );

  static TextStyle get font18WhiteRegular => TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.regular,
    color: Colors.white,
  );

  static TextStyle get font34BlackExtraBold => TextStyle(
    fontSize: 34.sp,
